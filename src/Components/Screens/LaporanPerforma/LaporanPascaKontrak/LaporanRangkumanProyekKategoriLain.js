...
import ReportProyekPerAnotherCategory from '../../../Table/ReportProyekPerAnotherCategory'
import ReportProyekByDue from '../../../Table/ReportProyekByDue'

function LaporanRangkumanProyekBulanan() {
            ...
            <Grid container>
              ...
              <Grid item container alignItems="center" justify="center">
                <Grid item md={6} sm={12}>
                  <ReportProyekPerAnotherCategory reportPerYearListView={[]} year={year}/>
                </Grid>
              </Grid>
              <Grid item container alignItems="center" justify="center">
                &nbsp;
              ...
              <Grid item container alignItems="center" justify="center">
                <Grid item md={6} sm={12}>
                  <ReportProyekByDue reportPerYearListView={[]} year={year}/>
                </Grid>
              </Grid>
            </Grid>
          </Paper>
...
export default LaporanRangkumanProyekBulanan